...
a value of 1 if it contains mostly type 2 (blue) particles, and a value of 0 if it contains mostly type 1 (red) particles.
    ...
    if count > skip and count % skip1 == 0:
     ...
     #reference frame.
        ...
        if count > print_from:
          ...
          #Average at the edge of the box, i.e. in the blue bulk.
